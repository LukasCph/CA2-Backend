...
public class FacadeExample {
    ...
    public List<List<Object>> getDataFromFiveServers() throws ExecutionException, InterruptedException {
        ...
        String[] hosts = {
                ...
                "https://secure.runescape.com/m=hiscore_oldschool/index_lite.ws?player=monke%20drip",
        };
        ...
        List<Object> playerStats = new ArrayList<>();
        playerStats.add(gson.fromJson(data.get(4), PlayerLookUpDTO.class));
